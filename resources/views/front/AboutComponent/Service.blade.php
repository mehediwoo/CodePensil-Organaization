                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('storage/'.$iteam->logo) }}" alt="">
                            </div>
                            <div class="services__style__two__content">
                                <h3 class="title"><a href="{{ route('service.details',$iteam->id) }}">{{ $iteam->title }}</a></h3>
                                <p>{!! substr($iteam->description,0,200) !!}</p>
                                <a href="{{ route('service.details',$iteam->id) }}" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
