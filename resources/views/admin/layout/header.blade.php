        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ asset('storage/'.Auth::user()->profile_image) }}" alt="" class="avatar-md rounded-circle">
                    @else
                    <img class="rounded-circle header-profile-user" src="{{ asset('admin/assets/images/profile.jpg') }}" alt="" class="avatar-md rounded-circle">
                    @endif
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="ri-wallet-2-line align-middle me-1"></i> Reset Password</a>
