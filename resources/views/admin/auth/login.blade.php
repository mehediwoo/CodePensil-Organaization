...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login | Rasalina - Admin & Dashboard </title>
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="email" name="email" required="" placeholder="E-mail" value="{{ old('email') }}">
                                        @error('email')
